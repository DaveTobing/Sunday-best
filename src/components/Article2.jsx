        ...
        <div className = {`
            ${theme ? "bg-background-dark-200" : "bg-background-dark-400" } w-full`}>
                <div className='py-16 px-32'>
                    ...
                    <h1 className={`
                        ${theme ? "text-light-600" : "text-light-450" } text-center text-3xl font-lora font-bold mt-3`}>Alkohol Tersehat yang Dapat Anda Konsumsi</h1>
                    <p  className={`
                ...
                <div className='flex flex-col items-center gap-4 mt-4'>
                    <h1 className={`
                        ${theme ? "text-light-600" : "text-light-450" } text-3xl font-lora font-bold mt-3`}>Bir</h1>
                ...
                <div className='flex flex-col items-center gap-4 mt-4'>
                    <h1 className={`
                        ${theme ? "text-light-600" : "text-light-450" } text-3xl font-lora font-bold mt-3`}>Wine</h1>
                ...
                <div className='flex flex-col items-center gap-4 mt-4'>
                    <h1 className={`
                        ${theme ? "text-light-600" : "text-light-450" } text-3xl font-lora font-bold mt-3`}>Sake</h1>
                ...
                <div className='flex flex-col items-center gap-4 mt-4'>
                    <h1 className={`
                        ${theme ? "text-light-600" : "text-light-450" } text-3xl font-lora font-bold mt-3`}>Soju</h1>
                ...
                <div className='flex flex-col items-center gap-4 mt-4'>
                    <h1 className={`
                        ${theme ? "text-light-600" : "text-light-450" }text-3xl font-lora font-bold mt-3`}>Vodka</h1>
                ...
                <div className='flex flex-col items-center gap-4 mt-4'>
                    <h1 className={`
                        ${theme ? "text-light-600" : "text-light-450" } text-3xl font-lora font-bold mt-3`}>Brandy</h1>
                ...
                <div className='flex flex-col items-center gap-4 mt-4'>
                    <h1 className={`
                        ${theme ? "text-light-600" : "text-light-450" } text-3xl font-lora font-bold mt-3`}>Rum</h1>
                ...
                <div className='flex flex-col items-center gap-4 mt-4'>
                    <h1 className={`
                        ${theme ? "text-light-600" : "text-light-450" } text-3xl font-lora font-bold mt-3`}>Absinthe</h1>
