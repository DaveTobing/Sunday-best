        ...
        className = {`w-full`} >
            <div className='py-16 px-10 lg:px-32'>
                <div className='flex flex-col items-center gap-4'>
                    <h1 className={`
                        text-center text-xl lg:text-3xl font-bold mt-3`}>SEJARAH WINE DARI MASA KE MASA</h1>
                    <p className={`
                ...
                <div className='flex flex-col gap-4 mt-4'>
                    <h1 className={`
                        text-center text-xl lg:text-3xl font-bold mt-3`}> 7000 SM</h1>
                    <p className={`
                        mt-3 text-md lg:text-xl text-center`}>
                ...
                <div className='flex flex-col gap-4 mt-4'>
                    <h1 className={`
                        text-center text-xl lg:text-3xl font-bold mt-3`}>5000 SM</h1>
                    <p className={`
                        mt-3 text-md lg:text-xl text-center`}>
                ...
                <div className='flex flex-col gap-4 mt-4'>
                    <h1 className={`
                        text-center text-xl lg:text-3xl font-bold mt-3`}>4000 SM</h1>
                    <p className={`
                        mt-3 text-md lg:text-xl text-center`}>
                ...
                <div className='flex flex-col gap-4 mt-4'>
                    <h1 className={`
                       text-center text-xl lg:text-3xl font-bold mt-3`}>1600-1000 SM</h1>
                    <p className={`
                       mt-3 text-md lg:text-xl text-center`}>
                ...
                <div className='flex flex-col gap-4 mt-4'>
                    <h1 className={`
                       text-center text-xl lg:text-3xl font-bold mt-3`}>900 SM</h1>
                    <p className={`
                        mt-3 text-md lg:text-xl text-center`}>
                ...
                <div className='flex flex-col gap-4 mt-4'>
                    <h1 className={`
                        text-center text-xl lg:text-3xl font-bold mt-3`}>1000</h1>
                    <p className={`
                         mt-3 text-md lg:text-xl text-center`}>
                ...
                <div className='flex flex-col gap-4 mt-4'>
                    <h1 className={`
                       text-center text-xl lg:text-3xl font-bold mt-3`}>1400-1500</h1>
                    <p className={`
                       mt-3 text-md lg:text-xl text-center`}>
                ...
                <div className='flex flex-col gap-4 mt-4'>
                    <h1 className={`
                    text-center text-xl lg:text-3xl font-bold mt-3`}>1740</h1>
                    <p className={`
                    mt-3 text-md lg:text-xl text-center`}>
                ...
                <div className='flex flex-col gap-4 mt-4'>
                    <h1 className={`
                        text-center text-xl lg:text-3xl font-bold mt-3`}>1964</h1>
                    <p className={`
                        mt-3 text-md lg:text-xl text-center`}>
                ...
                <div className='flex flex-col gap-4 mt-4'>
                    <h1 className={`
                        text-center text-xl lg:text-3xl font-bold mt-3`}>2010</h1>
                    <p className={`
                        mt-3 text-md lg:text-xl text-center`}>
