...
export default function Cards ({img, title1, title2, Price, size, details}) {
        ...
        <div className="absolute bg-background-light-100 p-4 w-[800px] h-[500px] rounded-lg">
          <div className='flex justify-between'>
            ...
            <div className='flex flex-col items-center'>
              <h1 className='text-[#F1EA3E] font-bold text-2xl'>Detail</h1>
          ...
          <div className='flex flex-col justify-around'>
            <div className='bg-[#1D1D1D] bg-opacity-20 rounded-lg w-[380px] h-[80px]'>
              <div className='flex flex-row gap-4 items-center justify-start m-2'>
                <h1 className='font-bold text-xl text-[#0175B8]'>{title1} {title2}</h1>
              </div>
              <div className='m-2 justify-between flex flex-row'>
                <p className='text-[#F1EA3E] text-xl font-medium'>{Price}</p>
                <p className='text-[#0175B8] text-xl font-medium'>{size}</p>
              </div>
            </div>
            <div>
              <div className='flex flex-row gap-4 items-center'>
                <h1 className='font-bold text-lg text-[#0175B8]'>Details:</h1>
              </div>
              <p className='text-left'>{details}</p>
            </div>
            <button className='bg-[#1D1D1D] bg-opacity-20 rounded-lg w-[380px] h-[50px] text-[#0175B8] font-bold text-xl'>
