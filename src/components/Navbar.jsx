    ...
    className={`
      ...
      >
        ...
        <div className='flex flex-row mx-4 md:mx-60 my-2 justify-between items-center'>
          <div className='flex flex-row items-center gap-4 justify-start'>
            ...
            <div className='mx-0 pr-4 md:mx-10 md:pr-0 gap-6 flex flex-row'>
              <img src={Search} alt="" />
              ...
              <label className={`btn-circle swap md:hidden ${nav ? 'swap-rotate' : ''}  ${theme ? "bg-background-light-300" : "bg-background-light-400"}`}>
      ...
      {showStore && (
          ...
          style={{ 
            ...
            <div className="w-[350px] h-[480px] absolute p-4 md:w-[800px] md:h-[500px] rounded-lg" 
            style={{ 
