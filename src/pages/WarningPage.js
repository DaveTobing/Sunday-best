            ...
            <div className="warningPage">
                <div className="content font-signika">
                    ...
                    <div className="socials">
                        <a href="https://www.instagram.com/sundaybestid/" target="_blank" rel="noopener noreferrer">
                            <SocialIcon network="instagram" bgColor="transparent" style={{ height: 25, width: 25 }}/>
                        </a>
                        <a href="https://api.whatsapp.com/send/?phone=62818688448&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer">
